...
CREATE INDEX idx_user_quests_universal ON user_quests(is_universal) WHERE is_universal = true;
CREATE INDEX idx_user_quests_expires ON user_quests(expires_at) WHERE expires_at IS NOT NULL;
